        ...
        if mouse_hit(element) then
          ...
          if element.thumbnail and not thumbfast.disabled then
            ...
            if osd_w then
              ...
              local thumbX =
                math.min(osd_w - thumbfast.width - thumbMarginX, math.max(thumbMarginX, tx / r_w - thumbfast.width / 2))
...
function validate_user_opts()
  if user_opts.windowcontrols ~= "auto" and user_opts.windowcontrols ~= "yes" and user_opts.windowcontrols ~= "no" then
...
function osc_init()
  ...
  ne.eventresponder["mbtn_mid_up"] = function()
